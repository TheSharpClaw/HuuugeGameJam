...
namespace HuuugeGame.Components
{
    class ComponentInfo : StateTemplate
    {
        ...
        public void Draw()
        {
            ...
            Globals.spriteBatch.Draw(Globals.hpBar, new Rectangle((int)Globals.screenSize.X/2-Globals.hpBar.Width, 47, 104, 22), new Color(0, 0, 0, 150));
            Globals.spriteBatch.DrawString(Globals.defaultFont, "CONTROL", new Vector2(Globals.screenSize.X/2-50, 50), Color.White);
            ...
            //Globals.spriteBatch.Draw(Globals.hpBar, new Rectangle((int)Globals.screenSize.X / 4 - Globals.hpBar.Width, (100 + Globals.spiderStaticTexture.Height * 2 + Globals.wsadIMG.Height + 60), 132, 22), new Color(0, 0, 0, 150));
            ...
            Globals.spriteBatch.Draw(Globals.flowerTexture, new Rectangle(((int)Globals.screenSize.X / 4)*3 + 85, 100 + Globals.spiderStaticTexture.Height * 2 + Globals.wsadIMG.Height + 120, Globals.flowerTexture.Width, Globals.flowerTexture.Height), Color.White);
